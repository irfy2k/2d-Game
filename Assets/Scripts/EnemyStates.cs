...
public class EnemyAttack : EnemyState
{
    ...
    public override void Enter()
    {
        ...
        // Make sure the enemy starts the attack completely stationary.
        _ec.StopMovement();
    ...
    public override void PhysicsUpdate()
    {
        // While in the attack state, continuously zero horizontal velocity so
        // the enemy cannot slide or be moved by residual forces during the animation.
        _ec.StopMovement();
    }
...
public class EnemyDead : EnemyState
{
    ...
    private IEnumerator DeathSequence()
    {
        ...
        // Notify listeners (e.g. EndlessGameManager) that this enemy was killed
        EnemyController.OnEnemyKilled?.Invoke(_ec);
