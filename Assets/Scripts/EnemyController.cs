...
{
    /// <summary>
    /// Fired exactly once when this enemy finishes its death sequence and is destroyed.
    /// Used by the EndlessGameManager to award score and respawn.
    /// Note: this is a plain delegate (not a C# event) so it can be invoked from EnemyStates.
    /// </summary>
